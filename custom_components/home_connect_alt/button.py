...
class HomeConnectRefreshButton(ButtonEntity):
    ...
    _attr_unique_id = "homeconnect_refresh"
    _attr_name = "Home Connect Refresh"
...
class HomeConnecDebugButton(ButtonEntity):
    ...
    _attr_device_info = HOME_CONNECT_DEVICE
    _attr_unique_id = "homeconnect_debug"
    _attr_name = "Home Connect Debug Info"
    ...
    async def async_press(self) -> None:
        ...
        try:
            ...
            raise HomeAssistantError("Failed to serialize to JSON") from ex
